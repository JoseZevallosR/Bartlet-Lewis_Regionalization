...
gauge_stats=read.csv('D:/Proyectos_GitHub/Bartlet-Lewis_Regionalization
                     /data/gauge_stats_feb_filtered.csv')


#Model CV parameters
validation_parameters=read.csv('D:/Proyectos_GitHub/Bartlet-Lewis_Regionalization
                               /output/CV_validation/CrossValidationParameters2.csv',sep =',')
...
file_save_name="D:/Proyectos_GitHub/Bartlet-Lewis_Regionalizatio
n/output/img/cv_stats_february.png"

plot_comparison(gauge_stat = gauge_stat,
                simulated_stats = simulated_stats,
                file_save_name = file_save_name,
                language = 'English')

file_save_name="D:/Proyectos_GitHub/Bartlet-Lewis_Regionalization
/output/img/cv_estadisticos_febrero.png"
